  ...
  return (
    <div className="flex h-full bg-bg">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Header */}
        <header className="flex items-center justify-between bg-surface px-4 py-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.25)]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="New chat"
              className="flex items-center justify-center h-9 w-9 rounded-xl bg-surface-2 border border-white/10 text-fg-2 hover:bg-surface-3 hover:text-fg transition-colors"
            >
              <NewChatIcon />
            </button>
            <button
              ...
              title="Settings"
              className="flex items-center justify-center h-8 w-8 rounded-lg text-fg-3 hover:text-fg transition-colors"
            >
              <GearIcon />
            </button>
          </div>
